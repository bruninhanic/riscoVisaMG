...
st.header('Consulta a classificação do risco sanitário de estabelecimentos segundo a legislação vigente do Estado de Minas Gerais')
st.subheader('Resolução SES/MG n. 7426/2021')
